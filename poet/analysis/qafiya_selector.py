...
class QafiyaSelector(Node):
    ...
    def _generate_reasoning(self, input_data: Dict[str, Any], output_data: Dict[str, Any]) -> str:
        ...
        reasoning = f"I selected and enriched the qafiya specification."
        
        if constraints and enhanced_constraints:
            reasoning += f" The selection was influenced by the theme '{constraints.theme}' and meter '{constraints.meter}'."
            reasoning += f" Enhanced qafiya: {enhanced_constraints.qafiya} ({enhanced_constraints.qafiya_type.value}, {enhanced_constraints.qafiya_harakah})"
        
        reasoning += " This complete qafiya specification will help create a cohesive and harmonious poem."
    ...
    def _summarize_input(self) -> str:
        ...
        if constraints:
            return f"Selected qafiya for theme: {constraints.theme}, meter: {constraints.meter}"
        return "Selected qafiya"
